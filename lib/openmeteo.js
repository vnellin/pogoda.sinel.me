...
// WSL2 и часть dev-окружений имеют сломанный IPv6 outbound — undici (fetch)
// падает на DNS с "fetch failed". Заставляем резолвер ставить IPv4 первым.
// Глобально для процесса (но эффект только на новые DNS-запросы).
