...
export const metadata = {
  // template работает с title, который страницы возвращают строкой.
  // Если страница вернёт `title: "Москва"` — выйдет "Москва — Погода".
  // Если не вернёт ничего — используется default.
  title: {
    template: "%s — Погода",
    default: "Погода — архив с 1979 года и прогноз",
  },
  description:
